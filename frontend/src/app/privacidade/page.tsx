            ...
            <div className="max-w-4xl mx-auto px-6 py-16">
                <div className="bg-white p-12 rounded-3xl shadow-sm border border-slate-100">
                    ...
                    <div className="prose prose-slate max-w-none text-slate-600 space-y-6">
                        ...
                        <p>
                            A sua privacidade é importante para nós. É política da <strong>FINHOUSE (CNPJ: 60.806.192/0001-50)</strong> respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar na plataforma Doqs.
                        </p>
                        ...
                        <section className="bg-slate-50 p-6 rounded-xl border border-slate-200">
                            ...
                            <p>
                                Entendemos que os documentos enviados ao Doqs são protegidos por sigilo profissional. Por isso:
                            </p>
                            <ul className="list-disc pl-6 space-y-2 mt-4">
                                ...
                                <li><strong>Sem Treinamento Público:</strong> O Doqs NÃO utiliza seus documentos ou interações para treinar modelos de inteligência artificial de terceiros ou modelos públicos.</li>
                        ...
                        <section>
                            ...
                            <p>
                                Você é livre para recusar a nossa solicitação de informações pessoais, entendendo que talvez não possamos fornecer alguns dos serviços desejados. O Doqs está em total conformidade com a LGPD, garantindo ao usuário o direito de exclusão total de seus dados a qualquer momento através da plataforma.
                            </p>
                        </section>
