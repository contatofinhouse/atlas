                ...
                <div className="bg-white p-12 rounded-3xl shadow-sm border border-slate-100">
                    ...
                    <div className="prose prose-slate max-w-none text-slate-600 space-y-6">
                        ...
                        <section>
                            ...
                            <p>
                                Ao acessar a plataforma LukaLex, operada pela <strong>FINHOUSE (CNPJ: 60.806.192/0001-50)</strong>, você concorda em cumprir estes termos de serviço e todas as leis aplicáveis.
                            </p>
                        </section>
                        ...
                        <section className="bg-emerald-50 p-6 rounded-xl border border-emerald-100">
                            ...
                            <p className="text-emerald-800">
                                <strong>IMPORTANTE:</strong> O LukaLex é uma ferramenta de produtividade jurídica baseada em inteligência artificial. O sistema auxilia na análise de documentos e extração de dados, porém:
                            </p>
                            <ul className="list-disc pl-6 text-emerald-800 space-y-2 mt-4">
                                <li><strong>Não fornece aconselhamento jurídico:</strong> O LukaLex não substitui a consultoria legal profissional.</li>
                        ...
                        <section>
                            ...
                            <p>
                                Os materiais na plataforma da LukaLex são fornecidos 'como estão'. A Finhouse não oferece garantias, expressas ou implícitas, e, por este meio, isenta e nega todas as outras garantias, incluindo, sem limitação, garantias implícitas ou condições de comercialização ou adequação a um fim específico.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <p>
                                Em nenhum caso a Finhouse ou seus fornecedores serão responsáveis por quaisquer danos (incluindo, sem limitação, danos por perda de dados ou lucro ou devido a interrupção dos negócios) decorrentes do uso ou da incapacidade de usar os materiais no LukaLex.
                            </p>
                        </section>
                    </div>
                </div>
