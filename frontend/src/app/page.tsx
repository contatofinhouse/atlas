                    ...
                    <div className="max-w-7xl mx-auto w-full relative z-10">
                        <div className="max-w-3xl text-left">
                            ...
                            <p className="text-xl md:text-2xl text-slate-500 max-w-xl mb-12 leading-relaxed">
                                O <span className="font-semibold text-slate-900">LukaLex</span> automatiza a análise documental com o rigor e a sofisticação que seu escritório exige.
                            </p>
                ...
                <section className="py-24 bg-white">
                    <div className="max-w-6xl mx-auto px-6 text-center">
                        ...
                        <p className="mt-10 text-slate-400 text-sm">
                            O LukaLex adapta seu raciocínio jurídico à doutrina e jurisprudência específica de cada ramo.
                        </p>
                    </div>
                </section>
                    ...
                    <div className="pt-8 border-t border-gray-100">
                        <div className="bg-slate-50 p-4 rounded-lg mb-8">
                            <p className="text-[11px] text-slate-400 leading-relaxed text-center">
                                <strong>DISCLAIMER:</strong> O LukaLex é uma ferramenta de produtividade jurídica operada por inteligência artificial. Os resultados gerados devem ser validados e revisados por advogados qualificados. O LukaLex não fornece aconselhamento jurídico ou consultoria legal e não substitui a atuação profissional do advogado. A Finhouse não se responsabiliza por erros decorrentes da má interpretação ou uso indevido da ferramenta.
                            </p>
                        </div>
                        <p className="text-xs text-slate-400 text-center font-medium">
                            © 2026 LukaLex IA • CNPJ: 60.806.192/0001-50 • Todos os direitos reservados.
                        </p>
                    </div>
                </div>
            </footer>
