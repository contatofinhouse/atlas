                ...
                <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0">
                    <div className="px-6 pt-3 pb-5 flex-1 overflow-y-auto">
                        ...
                        <input
                            ...
                            placeholder="Adicionar número CM..."
                        ...
                        <div className="mt-4 flex flex-wrap items-center gap-2">
                            ...
                            >
                                ...
                                Membros{sharedEmails.length > 0 ? ` (${sharedEmails.length})` : ""}
                            </button>
                        </div>
                        ...
                        {showMembers && (
                            <div className="mt-3">
                                <EmailPillInput
                                    ...
                                    placeholder="Adicione colegas por e-mail…"
                                />
                            </div>
                        )}
                        ...
                        <div className="mt-4 space-y-2">
                            <p className="text-xs font-medium text-gray-700">Selecionar documentos</p>
                                <FileDirectory
                                    ...
                                    emptyMessage="Nenhum documento existente"
                                />
                    ...
                    <div className="flex items-center justify-between border-t border-gray-100 px-6 py-4 shrink-0">
                        <div className="flex items-center gap-2">
                            ...
                            >
                                ...
                                Fazer upload{pendingFiles.length > 0 ? ` (${pendingFiles.length})` : ""}
                            </button>
                        </div>
                        <div className="flex items-center gap-2">
                            <button
